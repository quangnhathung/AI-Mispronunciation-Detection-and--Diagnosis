...
class L2ArcticDataset(Dataset):
    ...
    def _parse_textgrid(self, tg_path):
        ...
        for interval in phones_tier:
            ...
            # Bỏ qua các khoảng rỗng hoàn toàn (như interval cuối cùng trong ví dụ)
            if raw == "":
                continue
...
def collate_fn_factory(pad_phoneme_id: int = 0):
    def collate_fn(batch):
        ...
        ph_padded = pad_sequence(ph_list, batch_first=True, padding_value=pad_phoneme_id)   
